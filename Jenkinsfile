  ...
  try{
    ...
    stage('SonarQube analysis') {
			...
			withSonarQubeEnv('sonarqube-token') {
					bat "${scannerHome}/bin/sonar-scanner -X -Dsonar.host.url=https://sonarcloud.io/ -Dsonar.projectKey=Jurisprudencia_ORCTXT -Dsonar.sources=. -Dsonar.login=sqp_6f5ca85c5600080f204387f22e680a31f5c784b9"
			}
