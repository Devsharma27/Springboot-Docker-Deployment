  ...
  try{
    ...
    stage('SonarQube analysis') {
			...
			withSonarQubeEnv('sonarqube-token') {
					bat "${scannerHome}/bin/sonar-scanner -X sonar.host.url=https://localhost:9000/ sonar.organization=Devsharma27 sonar.projectKey=spring-boot-tk sonar.sources=. sonar.login=sqp_6f5ca85c5600080f204387f22e680a31f5c784b9"
			}
